...
import { z } from "zod";
import { retrieveContext, RAGSource } from "@/app/api/search/route";
...
export async function POST(req: Request) {
  ...
  If the question is unrelated to Groq's products and services, you should redirect the user to a human agent.
  ...
  try {
    ...
    // Format messages để include system prompt
  ...
  // Call Groq API với messages đã format
